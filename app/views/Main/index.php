  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <a class="navbar-brand" href="/"><?php system\core\Assets::img('images/logopresto2.png', "PRESTO MVC", "img-responsive imagen", "130", "25"); ?></a>
    </div>
...
<section id="welcome" class="container">
    <div class="jumbotron">
        <h1>Welcome to <?php system\core\Assets::img('images/logopresto2.png', "PRESTO MVC", "", "200", "70"); ?></h1>
